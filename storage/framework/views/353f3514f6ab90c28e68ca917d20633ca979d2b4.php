							...
							<tbody>
								<?php $__empty_1 = true; $__currentLoopData = $meetups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $meetup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($meetup->createdBy ?? $meetup->createdBy->name ?? ''); ?></td>
...
<?php echo $__env->make('backend.layouts.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\salawatproject.com\resources\views/backend/meetups/index.blade.php ENDPATH**/ ?>