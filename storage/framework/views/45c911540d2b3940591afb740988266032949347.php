      ...
      <div id="sidebar-menu">
         <ul class="sidebar-links custom-scrollbar">
            ...
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title <?php echo e(Route::currentRouteName()=='dashboard' ? 'active' : ''); ?>" style="cursor: pointer;">
            ...
            <li class="sidebar-list">
                ...
                <ul class="sidebar-submenu" style="display:block">
                   <li>
                      <a class="submenu-title active" href="<?php echo e(route('users.index')); ?>">Manage Users<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                   </li>
                </ul>
             </li>
         </ul>
...
<?php /**PATH G:\xampp\htdocs\salawatproject.com\resources\views/admin/layouts/dashboard/sidebar.blade.php ENDPATH**/ ?>