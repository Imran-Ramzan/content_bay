                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="media-body text-end">
                                                <label class="switch" for="<?php echo e($admin->id); ?>">
                                                    <input type="checkbox" id="<?php echo e($admin->id); ?>" data-bs-original-title="" title="" class="admin-toggle-class"  <?php echo e($admin->status ? 'checked' : ''); ?>>
                                        ...
                                        <td><?php echo e(($admin->roles->first() ? $admin->roles->first()->name : '')); ?></td>
                                        ...
                                        <td class="text-center">
                                            <div class="table-action">
                                                <a href="<?php echo e(route('admins.edit', $admin->id)); ?>"  data-user="<?php echo e(json_encode($admin)); ?>"class="jsgrid-button jsgrid-edit-button">
...
<?php echo $__env->make('portal.layouts.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\salawatproject.com\resources\views/portal/admins/index.blade.php ENDPATH**/ ?>