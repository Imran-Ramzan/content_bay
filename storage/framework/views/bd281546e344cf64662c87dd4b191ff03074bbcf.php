         ...
         <div class="login-card">
            <div>
               ...
               <div class="login-main">
                  <form class="theme-form needs-validation"  method="POST" action="<?php echo e(route('login')); ?>" novalidate="">
                      <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                     ...
                     <p class="mt-4 mb-0">Forgot Your Password?<a class="ml-2" href="<?php echo e(route('password.request')); ?>">Change Password</a></p>
                  </form>
               </div>
            </div>
         </div>
...
<?php echo $__env->make('admin.layouts.authentication.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\salawatproject.com\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>